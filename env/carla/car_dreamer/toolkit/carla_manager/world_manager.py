...
class WorldManager:
    ...
    def __init__(self, env_config):
        ...
        self._client = carla.Client("localhost", self._config.carla_port)
    ...
    def try_spawn_actor(
        ...
        print(f"[CARLA] Trying to spawn at {transform.location} with yaw {transform.rotation.yaw}")
    ...
    def spawn_actor(
        ...
        try_time = 0
        while actor is None and try_time < 10:
