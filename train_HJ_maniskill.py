...
class LatentManiskillEnv(gym.Env):
    ...
    """
    def __init__(self, args, ckpt_dir: str, device: str, with_proprio: bool, latent_h = False):
        super().__init__()
        # underlying Gym env
...
def main():
    ...
    train_envs = DummyVectorEnv(
        [lambda: LatentManiskillEnv(args, args.dino_ckpt_dir, args.device, args.with_proprio, latent_h = args.latent_h)
